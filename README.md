...
4. **QC_by_density_function.Rmd** - this markdown has the functions and the ways to run on your single cell data. Generally single cell data is individually thresholded by eyeballing the threshold value from countRNA and FeatureRNA violin plots. I tried to write up a function to detect where the violin plot tapers using the modal value on the plot. 
